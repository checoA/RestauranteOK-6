app.factory("barraService", [ '$location', '$resource','$q','orden_mesa','notificaciones',
	...
	return{
		...
		recuperarOrden:function(){
			...
			if(estado==0){
			return $resource(urls.servidor+"getOrden",{},{
				query:{
					method:'PUT',
					isArray:true
				}
				...
				return $resource(urls.servidor+"getOrdenEstado/:estado",{},{
					query:{
						method:'PUT',
		...
		cancelarVenta:function(productos){
			mesa = orden_mesa.getNumeroMesa();
			return $resource(urls.servidor+"cancelarVenta/:num_mesa",{},{
				save:{
					method:"PUT",
