...
public class MesasService {
	...
	public Mesas findByNumMesa(int num_mesa) {
		return mr.findByNumMesa(num_mesa);
	}
	
	public Mesas save(Mesas m) {
		return mr.save(m);
	}
	
	
	public void delete() {
		Mesas m = mr.findFirstByOrderByIdDesc();
		mr.delete(m);
	}
	...
	public void save(Long num_mesa) {
		Estados e = new Estados();
		e.setId(7L);
		Mesas m = mr.findByNumMesa(num_mesa.intValue());
		m.setEstado(e);
		mr.save(m);
	}
	
	public Mesas save(Long id,Detalle_ordenes d,Long estadoOrden) {
		Mesas m = mr.findByNumMesa(id.intValue());
		Estados e = new Estados();
		e.setId(estadoOrden);
	...
	public Mesas save(Long id, Long estado,Long estadoOrden) {
		Mesas m = mr.findByNumMesa(id.intValue());
		Estados e = new Estados();
		e.setId(estadoOrden);
		Ordenes o = or.findByNumMesaAndEstado(id.intValue(), e);
